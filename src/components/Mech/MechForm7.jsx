...
const MechForm7 = (props) => {
  const handleSubmit = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "mech-feedbacks/7/PPCE");
    ...
    var subject = "Process Planning and Cost Estimation";
    var staff = "Mr.G.Shastikumar";
    var credits =
      cc1 +
      cc2 +
      cc3 +
    ...
    alert(
      "Your Data has been recorded for PPCE. Continue with the next Subject"
    );
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "mech-feedbacks/7/PPE");

    var name = event.target.name.value;
    var regno = event.target.regno.value;
    var dept = event.target.dept.value;
    var sem = event.target.sem.value;
    var cc1 = parseInt(event.target.cc24.value);
    var cc2 = parseInt(event.target.cc2.value);
    var cc3 = parseInt(event.target.cc3.value);
    var cc4 = parseInt(event.target.cc4.value);
    var cc5 = parseInt(event.target.cc5.value);
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Power Plant Engineering";
    var staff = "Mr.P.Arun";
    var credits =
      cc1 +
      cc2 +
    ...
    alert("Your Data has been recorded for PPE. Continue with the next Subject");
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "mech-feedbacks/7/Mechatronics");
    ...
    var sem = event.target.sem.value;
    var cc1 = parseInt(event.target.cc1.value);
    var cc2 = parseInt(event.target.cc24.value);
    var cc3 = parseInt(event.target.cc3.value);
    var cc4 = parseInt(event.target.cc4.value);
    var cc5 = parseInt(event.target.cc5.value);
    var cc6 = parseInt(event.target.cc6.value);
    ...
    alert("Your Data has been recorded for Mechatronics. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "mech-feedbacks/7/UMP/");
    ...
    var cc1 = parseInt(event.target.cc1.value);
    var cc2 = parseInt(event.target.cc2.value);
    var cc3 = parseInt(event.target.cc24.value);
    var cc4 = parseInt(event.target.cc4.value);
    var cc5 = parseInt(event.target.cc5.value);
    var cc6 = parseInt(event.target.cc6.value);
    var cc7 = parseInt(event.target.cc7.value);
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Unconventional Machining processes";
    ...
    alert(
      "Your Data has been recorded for UMP. Continue with the next Subject"
    );
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "mech-feedbacks/7/Robotics/");
    ...
    var cc2 = parseInt(event.target.cc2.value);
    var cc3 = parseInt(event.target.cc3.value);
    var cc4 = parseInt(event.target.cc24.value);
    var cc5 = parseInt(event.target.cc5.value);
    var cc6 = parseInt(event.target.cc6.value);
    var cc7 = parseInt(event.target.cc7.value);
    var cc8 = parseInt(event.target.cc8.value);
    ...
    alert("Your Data has been recorded for Robotics. Continue with the next Subject");
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "mech-feedbacks/7/NDTE/");
    ...
    var cc3 = parseInt(event.target.cc3.value);
    var cc4 = parseInt(event.target.cc4.value);
    var cc5 = parseInt(event.target.cc24.value);
    var cc6 = parseInt(event.target.cc6.value);
    var cc7 = parseInt(event.target.cc7.value);
    var cc8 = parseInt(event.target.cc8.value);
    var cc9 = parseInt(event.target.cc9.value);
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Non Destructive Testing and Evaluation";
    var staff = "Mr.V.Mariappan";
    var credits =
      cc1 +
      cc2 +
    ...
    alert(
      "Your Data has been recorded for NDTE. Continue with the next Subject"
    );
  ...
  const handleSubmitNS_LAB = (event, props) => {
    event.preventDefault();
    const ref = collection(firestore, "mech-feedbacks/7/SA_LAB/");
    ...
    var cc4 = parseInt(event.target.cc4.value);
    var cc5 = parseInt(event.target.cc5.value);
    var cc6 = parseInt(event.target.cc24.value);
    var cc7 = parseInt(event.target.cc7.value);
    var cc8 = parseInt(event.target.cc8.value);
    var cc9 = parseInt(event.target.cc9.value);
    var cc10 = parseInt(event.target.cc10.value);
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Simulation and Analysis Laboratory";
    var staff = "Mr.V.Mariappan";
    var credits =
      cc1 +
      cc2 +
    ...
    alert(
      "Your Data has been recorded for SA Lab. Thank You for Giving your feedback"
    );
  ...
  const handleSubmitRES_LAB = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "mech-feedbacks/7/Mechatronics_LAB/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Mechatronics Laboratory";
    var staff = "Mr.J.Sugunthan";
    var credits =
      cc1 +
      cc2 +
    ...
    // document.getElementById("cc7").disabled = true;
    alert(
      "Your Data has been recorded for Mechatronics lab. Continue with the next Subject"
    );
  ...
  return (
    <div className="form-container">
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Process Planning and Cost Estimation</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitCC} id="f2">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Power Plant Engineering</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
            ...
            <ol className="feedback-form">
              <li className="feedback-list">
                <div className="item">
                  <h3>Punctuality in the Class</h3>
                  <select name="cc24" id="cns1" defaultValue="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Mechatronics</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
            ...
            <ol className="feedback-form">
              ...
              <li className="feedback-list">
                <div className="item">
                  <h3>Regularity in taking Classes</h3>
                  <select name="cc24" id="cns2" required defaultValue="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
      ...
      <form className="form" onSubmit={handleSubmitPOM} id="f4">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Unconventional Machining processes</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
            ...
            <ol className="feedback-form">
              ...
              <li className="feedback-list">
                <div className="item">
                  <h3>Completes syllabus of the course in time</h3>
                  <select name="cc24" id="cns3" defaultValue="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
      ...
      <form className="form" onSubmit={handleSubmitET} id="f5">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Robotics</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
            ...
            <ol className="feedback-form">
              ...
              <li className="feedback-list">
                <div className="item">
                  ...
                  <select name="cc24" id="cns4" defaultValue="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB} id="f6">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Non Destructive Testing and Evaluation</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
            ...
            <ol className="feedback-form">
              ...
              <li className="feedback-list">
                <div className="item">
                  <h3>Focus on Syllabi</h3>
                  <select name="cc24" id="cns5" defaultValue="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
      ...
      <form className="form" onSubmit={handleSubmitNS_LAB} id="f7">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Simulation and Analysis Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
            ...
            <ol className="feedback-form">
              ...
              <li className="feedback-list">
                <div className="item">
                  <h3>Self-confidence</h3>
                  <select name="cc24" id="cns6" defaultValue="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
      ...
      <form className="form" onSubmit={handleSubmitRES_LAB} id="f8">
        <Accordion>
          <AccordionSummary
            expandIcon={<ExpandMoreIcon />}
            aria-controls="panel1a-content"
            id="panel1a-header"
          >
            <Typography>Mechatronics Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
