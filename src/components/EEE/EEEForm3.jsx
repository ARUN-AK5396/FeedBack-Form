...
const EEEForm3 = () => {
  const handleSubmit = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/PCF");
    ...
    var subject ="Probability and Complex Function"
    var staff ="Ms.G.Jeyantha"
    ...
    alert("Your Data has been recorded for PCF. Continue with the next Subject");
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/EF/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Electromagnetic Fields"
    ...
    alert(
      "Your Data has been recorded for EF. Continue with the next Subject"
    );
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/DLC/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Digital Logic Circuits"
    ...
    alert("Your Data has been recorded for DLC. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/EDC/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Electron Devices and Circuits"
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/EM-I/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Electrical Machines - I"
    ...
    alert(
      "Your Data has been recorded for EM-I . Continue with the next Subject"
    );
  ...
  const handleSubmitSE = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/C_and_DataStr/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="C Programming and Data Structures"
    ...
    alert(
      "Your Data has been recorded for CD. Continue with the next Subject"
    );
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/3/EDC_lab/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Electronic Devices and Circuits Laboratory"
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Probability and Complex Functions</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitCC} id="f2">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Electromagnetic Fields</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Digital Logic Circuits</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitPOM} id="f4">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Electron Devices and Circuits</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitET} id="f5">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Electrical Machines - I</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitSE} id="f6">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>C Programming and Data Structures</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB} id="f7">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Electronic Devices and Circuits Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
