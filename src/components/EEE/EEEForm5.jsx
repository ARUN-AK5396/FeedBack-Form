...
const EEEForm5 = () => {
  const handleSubmit = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/PSA");
    ...
    var subject ="Power System Analysis"
    ...
    alert(
      "Your Data has been recorded for PSA. Continue with the next Subject"
    );
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/MPMC/");
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/PE/");
    ...
    alert("Your Data has been recorded for PE. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/DSP/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Digital Signal Processing"
    ...
    alert(
      "Your Data has been recorded for DSP. Continue with the next Subject"
    );
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/OOP/");
    ...
    alert("Your Data has been recorded for OOP. Continue with the next Subject");
  ...
  const handleSubmitSE = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/BBI/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Basics of Biomedical Instrumentation"
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/CI_LAB/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Control and Instrumentation Laboratary"
    var staff ="Ms.S.Praisy"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
      Name: name,
    ...
    alert(
      "Your Data has been recorded for CI Lab. Continue with the next Subject"
    );
  ...
  const handleSubmitNS_LAB = (event) => {
    ...
    const ref = collection(firestore, "eee-feedbacks/5/OOP_LAB/");
    ...
    alert(
      "Your Data has been recorded for OOP Lab. Thank You for Giving your feedback"
    );
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Power System Analysis</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Power Electronics</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitPOM} id="f4">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Digital Signal Processing </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitSE} id="f6">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Basics of Biomedical Instrumentation</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB} id="f7">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Control and Instrumentation Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
