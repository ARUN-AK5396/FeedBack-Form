...
const CivilForm5 = () => {
  const handleSubmit = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/DRCCE");
    ...
    var subject ="Design of ReinForced Cement Concrete Elements"
    ...
    alert(
      "Your Data has been recorded for DRCCE. Continue with the next Subject"
    );
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/SA/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Structural Analysis I"
    var staff ="Mrs.Dhana Lakshmi"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
      Name: name,
    ...
    alert("Your Data has been recorded for SA I. Continue with the next Subject");
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/WSE/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Water Supply Engineering"
    var staff ="Dr.Nalini Jebastina"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
      Name: name,
    ...
    alert("Your Data has been recorded for WSE. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/FE/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Foundation Engineering"
    var staff ="Ms.S.Prabha"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
      Name: name,
    ...
    alert(
      "Your Data has been recorded for FE. Continue with the next Subject"
    );
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/EA/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Environment and Agriculture"
    var staff ="Mrs.A.L.Swarna"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert("Your Data has been recorded for EA. Continue with the next Subject");
  ...
  const handleSubmitSE = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/DM/");
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/SM_LAB/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Soil Mechanics Laboratary"
    var staff ="Ms.S.Prabha"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
  ...
  const handleSubmitNS_LAB = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/5/WAWA_LAB/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Water and Wastewater Analysis Laboratory"
    var staff ="Mrs.A.L.Swarna"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert(
      "Your Data has been recorded for WAWA Lab. Thank You for Giving your feedback"
    );
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Design of Reinforced Cement Concrete Elements</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitCC} id="f2">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Structural Analysis I</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Water Supply Engineering</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitPOM} id="f4">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Foundation Engineering</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitET} id="f5">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Environment and Agriculture</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB} id="f7">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Soil Mechanics Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitNS_LAB} id="f8">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Water and WasteWater Analysis Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
