...
const CivilForm7 = (props) => {
  const handleSubmit = (event) => {
    event.preventDefault();

    const ref = collection(firestore, "civil-feedbacks/7/ECVE");
    ...
    var subject = "Estimation , Costing and Valuation Engineering";
    ...
    alert(
      "Your Data has been recorded for ECVE. Continue with the next Subject"
    );
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/7/RADHE");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Railways,Airports,Docks and Harbour Engineering";
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/7/SDD/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Structural Design and Drawing";
    ...
    alert("Your Data has been recorded for SDD. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/7/TQM/");
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/7/CCI/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Climate Change and its Impact";
    ...
    alert("Your Data has been recorded for CCI. Continue with the next Subject");
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/7/CIP/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject = "Creative and Innovative Project";
    var staff = "Dr.Nalini Jebastina";
    var credits =
      cc1 +
      cc2 +
    ...
    alert(
      "Your Data has been recorded for CIP. Continue with the next Subject"
    );
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Estimation, Costing and Valution Engineering</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitCC} id="f2">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Railways, Airports, Docks and Harbour Engineering</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Structural Design and Drawing</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitET} id="f5">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Climate Change and its Impact</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB} id="f6">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Creative and Innovative Project</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
