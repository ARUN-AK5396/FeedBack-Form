...
const CivilForm3 = () => {
  const handleSubmit = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/TPDE");
    ...
    var subject ="Transforms and Partial Different Equations"
    var staff ="Mr.R.Raman"
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/EM/");
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/FM/");
    ...
    alert("Your Data has been recorded for FM. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/CMT/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Construction Materials and Technology"
    var staff ="Mrs.S.Dhana Lakshmi"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
      Name: name,
    ...
    alert(
      "Your Data has been recorded for CMT. Continue with the next Subject"
    );
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/WSWE/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Water Supply and WasteWater Engineering"
    ...
    alert(
      "Your Data has been recorded for WSWE . Continue with the next Subject"
    );
  ...
  const handleSubmitSE = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/SL/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Surveying and Levelling"
    ...
    alert(
      "Your Data has been recorded for SL. Continue with the next Subject"
    );
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/SL_lab/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Surveying and Levelling Lab"
    var staff ="Mrs.S.Dhana Lakshmi"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert(
      "Your Data has been recorded for SL Laboratory. Thank You for Giving your feedback"
    );
  ...
  const handleSubmitNS_LAB = (event) => {
    ...
    const ref = collection(firestore, "civil-feedbacks/3/WWA_lab/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Water and WasteWater Analysis Lab"
    var staff ="Dr.Nalini Jebastina"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert(
      "Your Data has been recorded for WAWA lab. Continue with the next Subject"
    );
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Transforms and Partial Differential Equations</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitCC} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Fluid Mechanics</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f4">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Construction Material and Technology</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitPOM} id="f5">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Water Supply and WasteWater Engineering</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitET} id="f6">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Surveying and Levelling</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitSE} id="f7">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Surveying and Levelling Laboratory</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
