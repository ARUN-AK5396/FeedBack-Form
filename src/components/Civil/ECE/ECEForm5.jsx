...
const ECEForm5 = () => {
  const handleSubmit = (event) => {
    ...
    const ref = collection(firestore, "ese-feedbacks/5/DC");
    ...
    var subject ="Digital Communication"
    var staff ="Mrs.V.Sushmitha"
    ...
    alert(
      "Your Data has been recorded for DC. Continue with the next Subject"
    );
  ...
  const handleSubmitCC = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/DTSP/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Discrete Time Signal Processing"
    ...
    alert("Your Data has been recorded for DTSP. Continue with the next Subject");
  ...
  const handleSubmitDM = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/CAO/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Computer Architecture & Organization"
    ...
    alert("Your Data has been recorded for CAO. Continue with the next Subject");
  ...
  const handleSubmitPOM = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/CN/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Communication Networks"
    ...
    alert(
      "Your Data has been recorded for CN. Continue with the next Subject"
    );
  ...
  const handleSubmitET = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/ME/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Medical Electronics"
    ...
    alert("Your Data has been recorded for ME. Continue with the next Subject");
  ...
  const handleSubmitSE = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/BBI/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Basic of Biomedical Instrumentation"
    var staff ="Mr.M.Krishna Kumar"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert("Your Data has been recorded for BBI. Continue with the next Subject");
  ...
  const handleSubmitCC_LAB = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/CNLAB/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Communication Networks Lab"
    var staff ="Mr.R.James Nesaratnam"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert(
      "Your Data has been recorded for CN Lab. Continue with the next Subject"
    );
  ...
  const handleSubmitNS_LAB = (event) => {
    ...
    const ref = collection(firestore, "ece-feedbacks/5/CS_LAB/");
    ...
    var cc22 = parseInt(event.target.cc22.value);
    var cc23 = parseInt(event.target.cc23.value);
    var subject ="Communication Systems Lab"
    var staff ="Mrs.V.Sushmitha"
    var credits = cc1+cc2+cc3+cc4+cc5+cc6+cc7+cc8+cc9+cc10+cc11+cc12+cc13+cc14+cc15+cc16+cc17+cc18+cc19+cc20+cc21+cc22+cc23;
    var avg  = credits/23;
    let data = {
    ...
    alert(
      "Your Data has been recorded for CS Lab. Thank You for Giving your feedback"
    );
      ...
      <form className="form" onSubmit={handleSubmit} id="f1">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Digital Communication</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
      ...
      <form className="form" onSubmit={handleSubmitCC} id="f2">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Discrete Time Signal Processing</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitDM} id="f3">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Computer Architecture & Organization</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitPOM} id="f4">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Communication Networks</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitET} id="f5">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Medical Electronics</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitSE} id="f6">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Basic of Biomedical Instrumentation</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitCC_LAB} id="f7">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Communication Networks Lab</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
      ...
      <form className="form" onSubmit={handleSubmitNS_LAB} id="f8">
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Communication Systems Lab</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="item">
              <label htmlFor="name">Enter your name </label>
